######################
# Week 3
# Course 1 - Part 6 - Lesson 3
# Convolutions Sidebar
# loads image from scipy.misc, applies a convolution filter and a pool compression
# shows 3 pictures in total

# https://colab.research.google.com/drive/1XQ8GwKJxuxiSZpvprHFMRaIsDtlekdI0#scrollTo=DZ5OXYiolCUi
# https://github.com/lmoroney/dlaicourse/blob/master/Course%201%20-%20Part%206%20-%20Lesson%203%20-%20Notebook.ipynb
# As before, spend a little time playing with this notebook. Try different filters, and research different filter types. 
# There's some fun information about them here: https://lodev.org/cgtutor/filtering.html
...
# Now let's create a convolution. 
# We will iterate over the image, leaving a 1 pixel margin, 
# and multiply out each of the neighbors of the current pixel by the value defined in the filter.
# i.e. the current pixel's neighbor above it and to the left will be multiplied 
# by the top left item in the filter etc. etc. 
